...
class SendPluginsEmailCommand extends Command
{

    protected static $defaultName = 'reminder-plugins';
    /**
    ...
    public function __construct(PluginsRepository $pluginRepository, SendPluginsMail $mailer)
    {
        parent::__construct();
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $pluginExpiration = $this->pluginRepository->findPluginsExpirationDate();
